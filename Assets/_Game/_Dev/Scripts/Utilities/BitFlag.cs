...
public struct BitFlag8// : IBitFlag
{
    ...
    public BitFlag8(bool[] bitArray)
    {
        ...
        for (int i = 0; i < size; i++)
            if (bitArray[i]) flagsBytes = SetBit(i);
    }
...
public struct BitFlag16// : IBitFlag
{
    ...
    public BitFlag16(ushort bytesFlags) => flagsBytes = bytesFlags;
    ...
    public ushort ResetBit(int bit)
    {
        bit = Mathf.Clamp(bit, 0, 15);
        flagsBytes &= (ushort)(1 << bit);
        return flagsBytes;
    ...
    public ushort GetShort() => flagsBytes;
...
public struct BitFlag32// : IBitFlag
{
    ...
    public BitFlag32(uint bytesFlags) => flagsBytes = bytesFlags;
...
public struct BitFlag64// : IBitFlag
{
    ...
    public BitFlag64(ulong bytesFlags) => flagsBytes = bytesFlags;
    ...
    public ulong GetLong() => flagsBytes;
